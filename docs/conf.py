...
htmlhelp_basename = 'TestRepo1doc'
...
texinfo_documents = [
    ('index', 'TestRepo1', u'TestProject Documentation',
     u"Het Thakkar", 'TestProject',
     'Test project for checking development practices', 'Miscellaneous'),
]
