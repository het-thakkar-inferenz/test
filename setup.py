...
DESCRIPTION = metadata.get('description', 'Test project for checking development practices')
AUTHOR = metadata.get('author', 'Het Thakkar')
AUTHOR_EMAIL = metadata.get('author_email', 'thakkarhet41@gmail.com')
